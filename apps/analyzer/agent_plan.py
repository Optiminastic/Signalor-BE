...
def _action_dict(action: UserAction) -> dict:
    ...
    return {
        ...
        # Real measured GEO-score lift once the task is verified (else null). No
        # fabricated estimate; ranking is by priority + weakest pillar.
        "measured_lift": action.score_improvement,
        "effort": {
